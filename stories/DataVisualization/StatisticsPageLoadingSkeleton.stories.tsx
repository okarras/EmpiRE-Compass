...
import StatisticsPageLoadingSkeleton from '../../src/components/StatisticsPageLoadingSkeleton';
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This is the default loading skeleton for the statistics page layout, including six stat cards and a chart area placeholder.',
      },
    },
  },
};
