...
import data from '../../../data/query_5_data_2025-02-27.json'
  ...
  return (
    <div>
      { chart1 ? 
        ...
        <BarChartCustom settings={chartSetting} heading={"Normallzed number of secondary research used for data collection per year"} data={chart1} chartConfig={ {
          "xaxis": [{ scaleType: 'band', dataKey: 'year' }],
          "series": [
            { dataKey: 'survey ratio', label: 'Survey' },
          ],
