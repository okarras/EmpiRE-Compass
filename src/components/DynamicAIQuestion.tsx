...
\`\`\``;
  ...
  const handleGenerateAndRun = async () => {
    ...
    try {
      ...
      // Generate natural language translation of the SPARQL query
      try {
...
${combinedQueryForEditor}

Translation:`;

        const translationResult = await aiService.generateText(
          translationPrompt,
          {
            temperature: 0.3,
            maxTokens: 500,
        ...
        const translation = translationResult.text.trim();
        updateSparqlTranslation(translation, 'Auto-generated translation');
      } catch (translationError) {
        console.warn(
          'Failed to generate SPARQL translation:',
          translationError
        );
