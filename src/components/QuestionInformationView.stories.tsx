...
const meta: Meta<typeof QuestionInformationView> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Displays a sequence of contextual blocks (explanation, data requirements, analysis, interpretation) using multiple `QuestionInformation` components.',
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'This story simulates a full contextual explanation using mocked query data. All 4 blocks will render.',
      },
    },
  },
};